        ...
        if (data) {
            if(type == "add"){
                if(myChart != undefined){
                    ...
                    var marktToolData = [
                        $this.history_data[history_data.length - 1],
                        $this.z_history_data[z_history_data.length - 1],
                        $this.a_history_data[a_history_data.length - 1],
                        moment(parseFloat($this.c_data[history_data.length - 1])).format("YYYY-MM-DD HH:mm")
                    ];
